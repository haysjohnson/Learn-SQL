...
CREATE TABLE songs(
	id INT NOT NULL AUTO_INCREMENT,
    name VARCHAR(255) NOT NULL,
    length FLOAT NOT NULL, /* represents length in minutes */
...
SELECT albums.name AS Name, release_year AS 'Release Year' , SUM(songs.length) as Duration
FROM albums
